...
import com.qryde.qryderiderapp.data.repository.AddressSearchRepositoryImpl
...
import com.qryde.qryderiderapp.data.repository.RecurringTripsRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    abstract fun bindRecurringTripsRepository(impl: RecurringTripsRepositoryImpl): RecurringTripsRepository

    @Binds
    abstract fun bindAddressSearchRepository(impl: AddressSearchRepositoryImpl): AddressSearchRepository
}
